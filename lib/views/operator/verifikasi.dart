...
class OperatorVerifikasiView extends StatefulWidget {
  const OperatorVerifikasiView({Key? key}) : super(key: key);

  @override
  State<OperatorVerifikasiView> createState() => _VerifikasiViewState();
}

class _VerifikasiViewState extends State<OperatorVerifikasiView> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text("DATA PERIZINAN - VERIFIKASI VIEW"),
        centerTitle: true,
        elevation: 0,
      ),
      body: Column(
